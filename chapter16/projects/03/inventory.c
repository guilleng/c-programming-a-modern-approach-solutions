...
int find_part(const struct part inventory[], const int *num_parts, 
              const int number);
void insert(struct part inventory[], int *num_parts);
void search(const struct part inventory[], const int *num_parts);
void update(struct part inventory[], const int *num_parts);
void print(const struct part inventory[], const int *num_parts);
...
/*******************************************************************************
 * insert: Prompts the user to enter a part number. Prints an error message if *
