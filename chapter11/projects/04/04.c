/*
 * C programming: A Modern Approach. Chapter 11, Project 04
 * Date: March 2023
...
/*
 * read_cards: Reads the cards into the array variables num_in_rank and 
...
/*
 * analyze_hand: determines whether the hand received as parameter contains a 
 *               straight, a flush, four-of-a-kind, and/or three-of-a-kind; 
 *               determines the number of pairs; stores the results into the 
 *               pointer variables straight, flush, four, three, and pairs
 */
void analyze_hand(int num_in_rank[NUM_RANKS], int num_in_suit[NUM_SUITS],
                  bool *straight, bool *flush, 
                  bool *four,     bool *three, int *pairs)
 ...
 *               the pointer variables straight, flush, four, three, and pairs.
 */
void print_result(bool *straight, bool *flush, 
                  bool *four,     bool *three, int *pairs)
{
