...
/*******************************************************************************
 * compare_part_number: returns an integer less than, equal to, or greater than
 *                      zero if the part number `p` points to is less than, 
 *                      equal to, or greater than the part number `q` points to.
 ******************************************************************************/ 
int compare_part_number(const void *p, const void *q)
{
